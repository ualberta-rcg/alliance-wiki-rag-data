...
The [CRAN Task View on High-Performance and Parallel Computing with R](link-to-cran-task-view-here) describes a bewildering collection of interrelated R packages for parallel computing.
